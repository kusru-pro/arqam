...
The U.S. and Iran have exchanged strikes in the region, raising concerns about a wider conflict.
Reports from Reuters and AP indicate that negotiators are discussing a possible memorandum to halt the fighting and maintain a ceasefire.
However, Iranian officials have said that no final agreement has yet been approved, suggesting negotiations are still ongoing.
The United Nations has called for both sides to return fully to the ceasefire and avoid further escalation.`, color: "text-blue-500", bg: "bg-blue-50", image: "https://media.assettype.com/theleaflet/2025-06-28/jsewqdw5/US-Iran.jpg?w=1200&h=675&auto=format%2Ccompress&fit=max&enlarge=true" },
            { id: 3, title: "📰 World Cup 2026 Latest News (June 12, 2026)", author: "arqam unit", date: "June 5, 2026", desc: `The 2026 FIFA World Cup has officially started in North America, co-hosted by Mexico, United States, and Canada. This is the largest World Cup ever, featuring 48 teams and 104 matches.

In the opening match, Mexico defeated South Africa 2–0 in front of more than 80,000 fans at Estadio Azteca.
South Korea came from behind to beat Czech Republic 2–1 in another opening-day match.
A major talking point has been the presence of empty seats at some matches, with fans and supporter groups criticizing high ticket prices. FIFA says overall demand remains strong.
