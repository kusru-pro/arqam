...
const state = {
    ...
    data: {
        news: [
            { id: 1, title: "📰 യൂണിറ്റിൽ ലൈബ്രെറിക്ക് തുടക്കം", author: "Arqam corner", date: "June 19, 2026", desc: " ജൂൺ 19 വായനാദിനവുമായി ബന്ധപ്പെട്ട് arqam unit ക്ലാസ്സിൽ ഒരു ലൈബ്രെറിക്ക് തുടക്കം കുറിച്ചു. ഉൽഘടനം hida സെക്രട്ടറി മിസ്ബാഹ് ഒറ്റപ്പാലം നിർവഹിച്ചു. വായനയുടെ ഗുണങ്ങളെപറ്റിയും അതിന്റെ പ്രാധാന്യവും വിദ്യാർത്ഥികൾക്ക് വിവരിച്ചുകൊടുത്തു.UC മുബഷിർ കുഞ്ഞിപ്പള്ളി സാന്നിധ്യം അറിയിച്ചു . ശാമിൽ കുട്ടോത്ത് സ്വാഗതവും ശാദി ഫർഹാൻ നന്ദിയും പറഞ്ഞ് പരിപാടി അവസാനിച്ചു.ലൈബ്രെറിയിൽ ഏതൊക്കെ പുസ്തകങ്ങൾ ഉണ്ടെന്ന് ലൈവായി arqamiz ൽ ലഭിക്കും.",  color: "text-yellow-500", bg: "bg-yellow-50", image: "https://i.pinimg.com/736x/ae/38/0d/ae380d5f51bbb4ef58edcab2614b713f.jpg" },
